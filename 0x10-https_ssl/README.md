...
confcertificate and HAproxy
SSL termination.

## Tasksigured my HolbertonBnB web servers with `certbot`  :page_with_curl:
...
* **2. HAproxy SSL termination**
  * ation): HAproxy
  configuration file that accepts [2-haproxy_ssl_termination](./2-haproxy_ssl_terminencrypted SSL traffic for the subdomain
  `www.` on TCP port 443.
