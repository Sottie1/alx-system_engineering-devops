...
and Fabric to transfer files to my server.  the server using Nginx.

The server is accessibleAdditionally, I completed a basic
configuration of at [bdbnb.site](http://bdbnb.site).

## Tasks :page_with_curl:

* **0. Transfer a file to your server**
  * [0-transfer_file](./0-transfer_file): Bash script that transfers a file
  from Holberton's   * The path of the file to be transferred.
    * client to a server.
...
* **3. Redirection**
  ...
  * Setup is identical to [1-install_nginx_web_server](./1-install_nginx_web_server)
  `301 Moved Permanently` redirection
    to anothe plus:
    * The location `/redirect_me` returns ar page.
...
* **5. Design a beautiful 404 page**
  * A custom-designed 404 error paghttp://bdbnb.site/404).

* **6. Deploy fast, deploe for my server, accessible at
  [bdbnb.site/404](y well**
